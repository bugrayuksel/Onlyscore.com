...
$(".soccer-result-items").click(function () {
    window.open("result.html");
})
$(".tennis-result-items").click(function () {
    window.open("result_tennis.html");
})
$(".basket-result-items").click(function () {
    window.open("result_basket.html");
})
var mdatetog = 0;
$(".fa-calendar").click(function () {
    if (mdatetog == 0) {
        $(".m-date").css("visibility", "visible");
        mdatetog = 1;
    } else {
        $(".m-date").css("visibility", "hidden");
        mdatetog = 0;
    }
})
